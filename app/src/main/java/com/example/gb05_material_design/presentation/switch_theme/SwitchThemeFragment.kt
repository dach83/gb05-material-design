package com.example.gb05_material_design.presentation.switch_theme
...
import com.example.gb05_material_design.databinding.FragmentSwitchThemeBinding
...
class SwitchThemeFragment : Fragment() {
    ...
    private fun onClickSwitchThemeButton(button: View) {
        ...
        activity?.let { activity ->
            ThemePreferencesHelper.saveTheme(activity, themeId)
            activity.recreate()
        }
    }
