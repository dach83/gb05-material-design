...
fun todoTextAdapterDelegate(onClickItem: (TodoTextItem) -> Unit) = adapterDelegateViewBinding<TodoTextItem, TodoItem, ItemTextTodoBinding>(
...
fun todoImageAdapterDelegate(onClickItem: (TodoImageItem) -> Unit) = adapterDelegateViewBinding<TodoImageItem, TodoItem, ItemImageTodoBinding>(
